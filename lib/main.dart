    ...
    text.splitMapJoin(
      ...
      onNonMatch: (String nonMatch) {
        if (lastMatchEnd < text.length) {
          // This is handled by onMatch for pieces between matches
        }
        return '';
      },
    );
...
class _EditorScreenState extends State<EditorScreen> {
  ...
  void _onTextChanged() {
    ...
    if (selection.isCollapsed && selection.baseOffset >= 0) {
      ...
      // Extract custom variables (section names)
      ...
      if (lastWordMatch != null) {
        ...
        // Suggest keywords at start of line
    ...
    _autocompleteOverlay = OverlayEntry(
      builder: (context) => Positioned(
        ...
        child: CompositedTransformFollower(
          ...
          offset: const Offset(50, 40), // Approximate position for now
          child: Material(
            elevation: 8,
  ...
  void _applySuggestion(String suggestion) {
    ...
    // Simple replacement of current word/prefix
    final beforeCursor = text.substring(0, _cursorPosition);
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              ...
              children: [
                ...
                // Editor with Autocomplete Target
                Expanded(
